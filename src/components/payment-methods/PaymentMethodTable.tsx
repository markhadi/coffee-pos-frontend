 ...
 */
const ActionButtons = ({ onEdit, onDelete, paymentMethod }: { onEdit: (paymentMethod: PaymentMethod) => void; onDelete: (paymentMethod: PaymentMethod) => void; paymentMethod: PaymentMethod }) => (
